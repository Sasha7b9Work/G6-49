...
/*! \page page03 3. Аппаратные сигналы генератора
    ...
    |          | 11 - режим манипуляции выключен. Выводится сигнал из памяти                    |
    ...
    +----------+--------------------------------------------------------------------------------+
    | 02h        20 бит - регистр размаха сигнала. Используется для установки коэффициента      |
    |            передачи каналов формирования сигнала произвольной формы.                      |
    +----------+--------------------------------------------------------------------------------+
    | D9...D0  | коэффициент передачи канала B                                                  |
    | D19...D10| коэффициент передачи канала А                                                  |
    +----------+--------------------------------------------------------------------------------+
    | 03h        28 бит - регистр кода сигнала прямоуголькой формы канала A. Используетя для    |
    ...
    |          | 1010 - 1кГц                                                                    |
    +----------+--------------------------------------------------------------------------------+
    | 0Ah         28 бит - задаёт смещения обоих каналов. В дополнительном коде.                |
    +----------+--------------------------------------------------------------------------------+
