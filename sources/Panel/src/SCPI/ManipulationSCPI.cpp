...
{
    return SCPI::ProcessParameterChoice(buffer, TypeCParam::ManipulationEnabled, enabledNames);
}
...
{
    return SCPI::ProcessParameterDouble(buffer, TypeDParam::DurationManipulation);
}
