...
static pchar FuncMeasure(pchar buf)
{
    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        if (end)
        {
            ...
            PageFrequencyCounter::OnPress_Measure(true, true);
...
static pchar FuncTimeCounting(pchar buffer)
{
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if (end)
        {
            ...
            PageFrequencyCounter::OnPress_BillingTime(true, true);
...
static pchar FuncLPF(pchar buffer)
{
    ...
    for (int i = 0; i < 2; i++)
    {
        ...
        if (end)
        {
            ...
            PageFrequencyCounter::OnPress_Filtr(true, true);
...
static pchar FuncCoupling(pchar buffer)
{
    ...
    for (int i = 0; i < 2; i++)
    {
        ...
        if (end)
        {
            ...
            PageFrequencyCounter::OnPress_Couple(true, true);
...
static pchar FuncResistance(pchar buffer)
{
    ...
    for (int i = 0; i < 2; i++)
    {
        ...
        if (end)
        {
            ...
            PageFrequencyCounter::OnPress_Resist(true, true);
...
static pchar FuncTest(pchar buffer)
{
    ...
    for (int i = 0; i < 2; i++)
    {
        ...
        if (end)
        {
            ...
            PageFrequencyCounter::OnPress_Test(true, true);
...
static pchar FuncTimeLabels(pchar buffer)
{
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if (end)
        {
            ...
            PageFrequencyCounter::OnPress_TimeStamps(true, true);
...
static pchar FuncNumberPeriods(pchar buffer)
{
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if (end)
        {
            ...
            PageFrequencyCounter::OnPress_AvePeriod(true, true);
