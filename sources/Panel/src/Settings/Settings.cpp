...
void TuneGenerator(Chan ch)
{
    ...
    Generator::SetFormWave(ch, Signal::GetForm(ch));
    ...
    Generator::SetParameter(ch, WaveParameter::Offset,    (&INPUT_WINDOW_STRUCT(ch, Signal::GetForm(ch), WaveParameter::Offset))->Value());
}
