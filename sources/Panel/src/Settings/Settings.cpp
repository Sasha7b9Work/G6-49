...
void TuneGenerator(Chan ch)
{
    ...
    Generator::SetFormWave(ch, Wave::GetForm(ch));
    ...
    Generator::SetParameter(ch, WaveParameter::Offset,    (&INPUT_WINDOW_STRUCT(ch, Wave::GetForm(ch), WaveParameter::Offset))->Value());
}
