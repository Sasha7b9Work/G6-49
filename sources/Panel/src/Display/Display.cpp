...
{
    // Íàõîäèì íîìåð ïåðâîé ïóñòîé ñòðîêè
    ...
    // Åñëè ïóñòîé ñòðîêè íåò
    if (numEmptyString == STRING_IN_CONSOLE)
    {
        // Òî ñäâèãàåì âñå ñòðîêè íà îäíó
...
void Display::DrawHint()
{
    if(IN_MODE_SHOW_HINTS)
    {
        ...
        Painter::DrawTextInBoundedRectWithTransfers(x0, y0, width, "ÂÊËÞ×¨Í ÐÅÆÈÌ ÏÎÄÑÊÀÇÎÊ.\nÄËß ÏÎËÓ×ÅÍÈß ÈÍÔÎÐÌÀÖÈÈ ÏÎ ÝËÅÌÅÍÒÓ ÌÅÍÞ ÈËÈ ÍÀÇÍÀ×ÅÍÈÞ ÊÍÎÏÊÈ "
        "ÈÑÏÎËÜÇÓÉÒÅ ÑÎÎÒÂÅÒÑÒÂÓÞÙÈÉ ÎÐÃÀÍ ÓÏÐÀÂËÅÍÈß.", Color::BACK, Color::FILL);
