...
namespace Painter
{
    ...
    int GetLenghtSubString(const char *text);

    int DrawSubString(int x, int y, const char *text);

    int DrawSpaces(int x, int y, const char *text, int *numSymbols);
    ...
    void DrawCharInColorDisplay(int eX, int eY, char symbol);

    int DrawCharWithLimitation(int eX, int eY, char symbol, int limitX, int limitY, int limitWidth, int limitHeight);
