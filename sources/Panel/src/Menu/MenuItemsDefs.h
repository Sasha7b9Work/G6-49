...
#define DEF_PAGE_5(name, titleRU, titleEN, hintRU, hintEN,                                                                                  \
    item1, item2, item3, item4, item5, namePage, keeper, funcActive, funcPress, funcOnKey)                                                  \
static Item * items##name[] = {(Item *)&item1, (Item *)&item2, (Item *)&item3, (Item *)&item4, (Item *)&item5};                             \
const PageBase name = { Item::Type::Page, 5, false, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                       \
    items##name, funcPress, FuncDrawPage, FuncRegSetPage, funcOnKey};
...
const PageBase name = { Item::Type::Page, 7, false, namePage, keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                       \
    items##name, funcPress, FuncDrawPage, FuncRegSetPage, funcOnKey};
...
static const ChoiceBase name = { Item_Choice, 7, false, Page::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                       \
    (int8 *)&cell, hints##name, hints##name##Ru, hints##name##En, funcChanged, funcDraw};
...
static const ChoiceBase name = { Item_Choice, 8, false, Page::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                       \
    (int8 *)&cell, hints##name, hints##name##Ru, hints##name##En, funcChanged, funcDraw};
