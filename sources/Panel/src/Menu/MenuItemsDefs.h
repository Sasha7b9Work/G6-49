...
static const ButtonBase name = { Item::Type::Button, 0, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},        \
    funcPress, funcDraw };

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define DEF_TIME(name, titleRU, titleEN, hintRU, hintEN, keeper, funcActive, cur, h, mi, s, mo, d, y)                                       \
static const TimeBase name = { TypeItem::E::Time, 0, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},           \
    &cur, &h, &mi, &s, &mo, &d, &y };

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define DEF_GOVERNOR(name, titleRU, titleEN, hintRU, hintEN, cell, min, max, keeper, funcActive, funcChanged, funcBeforeDraw)               \
static const GovernorBase name = { TypeItem::E::Governor, 0, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},   \
...
static const GovernorColorBase name = { TypeItem::E::GovernorColor, 0, false, Page::Name::NoPage, &keeper, FuncActive,                             \
...
ChoiceParameterBase name = { Item::Type::ChoiceParameter, 0, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN} ,  \
    funcPress, form};


//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define DEF_SMALL_BUTTON(name, titleRU, titleEN, hintRU, hintEN, keeper, funcActive, funcPress, funcDraw)                                   \
static const SButtonBase name = { Item::Type::SmallButton, 0, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},  \
    funcPress, funcDraw, 0, 0};

#define DEF_SMALL_BUTTON_EXIT(name, keeper, funcActive, funcPress, funcDraw)                                                                \
static const SButtonBase name = { Item_SmallButton, 0, false, Page::Name::NoPage, &keeper, funcActive, {"Выход", "Exit",                           \
...
static const SButtonBase name = { Item_SmallButton, 0, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},         \
...
static const ChoiceBase name = { Item::Type::Choice, 2, true, (Page::Name)numBit, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},  \
...
static const ChoiceBase name = { Item::Type::Choice, 3, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},        \
    (int8 *)&cell, hints##name, hints##name##Ru, hints##name##En, funcChanged, funcDraw};
...
static const ChoiceBase name = { Item::Type::Choice, 4, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                \
    (int8 *)&cell, hints##name, hints##name##Ru, hints##name##En, funcChanged, funcDraw};
...
static const ChoiceBase name = { Item::Type::Choice, 5, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                \
    (int8 *)&cell, hints##name, hints##name##Ru, hints##name##En, funcChanged, funcDraw};
...
static const ChoiceBase name = { Item::Type::Choice, 6, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                \
    (int8 *)&cell, hints##name, hints##name##Ru, hints##name##En, funcChanged, funcDraw};
...
static const ChoiceBase name = { Item_Choice, 7, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                       \
    (int8 *)&cell, hints##name, hints##name##Ru, hints##name##En, funcChanged, funcDraw};
...
static const ChoiceBase name = { Item_Choice, 8, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                       \
    (int8 *)&cell, hints##name, hints##name##Ru, hints##name##En, funcChanged, funcDraw};
...
static const ChoiceBase name = { Item::Type::Choice, 12, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},               \
    (int8 *)&cell, hints##name, hints##name##Ru, hints##name##En, funcChanged, funcDraw};
...
static const ChoiceBase name = { Item_ChoiceReg, 9, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                    \
...
static const ChoiceBase name = { Item_ChoiceReg, 10, false, Page::Name::NoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                   \
    (int8 *)&cell, hints##name, funcChanged, funcDraw};
