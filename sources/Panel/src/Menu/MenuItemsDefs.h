...
#define DEF_GOVERNOR(name, titleRU, hintRU, titleEN, hintEN, cell, min, max, keeper, funcActive, funcChanged)                               \
static const GovernorBase name = { TypeItem::Governor, 0, false, Page::NoPage, (const PageBase *)&keeper,                                   \
    {titleRU, hintRU}, {titleEN, hintEN}, funcActive, min, max, (int16 *)(&(cell)), funcChanged};
