...
Page *PageDebug::_Calibration::PageB::self = reinterpret_cast<Page *>(const_cast<PageBase *>(&pageCalibrationB));



static void OnChange_NegativeAD9952()
{
    PageDebug::_Calibration::WriteKoeffCal(Chan::B, KoeffCal::AD9952_NEG);
}

static void OnPress_NegativeAD9952(bool enter)
{
    PageDebug::_Calibration::OnPress_OffsetAD9952(Chan::B, enter, KoeffCal::AD9952_NEG);
}
...
{
    PageDebug::_Calibration::WriteKoeffCal(Chan::B, KoeffCal::AD9952_POS);
}

static void OnPress_PositiveAD9952(bool enter)
{
    PageDebug::_Calibration::OnPress_OffsetAD9952(Chan::B, enter, KoeffCal::AD9952_POS);
}
...
{
    PageDebug::_Calibration::WriteKoeffCal(Chan::B, KoeffCal::AD9952_ZERO);
}

static void OnPress_ZeroAD9952(bool enter)
{
    PageDebug::_Calibration::OnPress_OffsetAD9952(Chan::B, enter, KoeffCal::AD9952_ZERO);
}
...
{
    PageDebug::_Calibration::WriteKoeffCal(Chan::B, KoeffCal::AD9952_AMPL);
}

static void OnPress_AmplitudeAD9952(bool enter)
{
    PageDebug::_Calibration::OnPress_AmplitudeAD9952(Chan::B, enter, KoeffCal::AD9952_AMPL);
}
...
{
    PageDebug::_Calibration::WriteKoeffCal(Chan::B, KoeffCal::DDS_OFFSET);
}

static void OnPress_OffsetDDS(bool enter)
{
    PageDebug::_Calibration::OnPress_DDS(Chan::B, enter, KoeffCal::DDS_OFFSET);
}
...
{
    PageDebug::_Calibration::WriteKoeffCal(Chan::B, KoeffCal::DDS_MIN);
}

static void OnPress_MinDDS(bool enter)
{
    PageDebug::_Calibration::OnPress_DDS(Chan::B, enter, KoeffCal::DDS_MIN);
}
...
{
    PageDebug::_Calibration::WriteKoeffCal(Chan::B, KoeffCal::DDS_MAX);
}

static void OnPress_MaxDDS(bool enter)
{
    PageDebug::_Calibration::OnPress_DDS(Chan::B, enter, KoeffCal::DDS_MAX);
}
...
DEF_PAGE_8( pageCalibrationB,                                                                                                                     //--- НАСТРОЙКИ СИГНАЛОВ - КАЛИБРОВКА B --- 
    ...
    Page::Settings_CalibrationB, PageDebug::self, Item::FuncActive, Page::FuncEnter, FuncOnKey, Page::FuncDraw
)
