...
static ParameterDouble stored = ParameterAmplitude();    // Здесь будем сохранять настраиваемый параметр перед его изменением, чтобы восстановить в случае необходимости //-V1054

static ParameterDouble *tuned = nullptr;     // Настраиваемый параметр //-V1054
