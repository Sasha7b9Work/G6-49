...
InputWindow::Struct sig_structParameter[Chan::Number][Form::Number][Parameter::Number] =
{
        {
            {                                                                           // [A][Form::Sine]
/* Frequency  */ InputWindow::Struct(' ', "20000", 0),
/* Period     */ InputWindow::Struct(' ', "05000", 0),
/* Amplitude  */ InputWindow::Struct(' ', "50000", 0),
/* Offset     */ InputWindow::Struct(' ', "50000", 0),
...
/* Modulation */ InputWindow::Struct(' ', "10000", 0)
            },
            {                                                                           // [A][Form::RampPlus]
                InputWindow::Struct(' ', "10000", 0),
                InputWindow::Struct(' ', "10000", 0),
                InputWindow::Struct(' ', "10000", 1),
                InputWindow::Struct(' ', "50000", 0),
                InputWindow::Struct(' '),
                InputWindow::Struct(' '),
                InputWindow::Struct(' '),
                InputWindow::Struct(' '),
