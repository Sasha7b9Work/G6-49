...
static void TransformDataToCode(Form *form, float data[FPGA_NUM_POINTS]);
...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void TransformDataToCode(Form *form, float d[FPGA_NUM_POINTS])
{
    ...
    Message::LoadFromDDS((uint8)form->GetWave()->GetChannel(), code).Transmit();
}
