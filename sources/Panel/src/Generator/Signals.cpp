...
static ParameterManipulationDuration  param_SineModulationA_ManipulationDuration(FloatValue("0"), FloatValue("10"),    FloatValue("5"));
static ParameterManipulationPeriod    param_SineModulationA_ManipulationPeriod  (FloatValue("0"), FloatValue("10000"), FloatValue("0.002500"));
...
static ParameterPeriod    param_ImpulseA_Period   (FloatValue("33", -9), FloatValue("10", 6), FloatValue("0.001"));
static ParameterDuration  param_ImpulseA_Duration (FloatValue("0"),      FloatValue("100", 6), FloatValue("100", -6));
...
static ParameterPeriod       param_PacketA_Period       (FloatValue("0"), FloatValue("100", 6), FloatValue("200", -6));
static ParameterDuration     param_PacketA_Duration     (FloatValue("0"), FloatValue("100", 6), FloatValue("100", -6));
static ParameterValue        param_PacketA_PacketNumber (ParameterValueType::PacketNumber, "Кол-во имп", "Count imp", FloatValue("0"), FloatValue("100", 6), FloatValue("3"));
static ParameterPacketPeriod param_PacketA_PacketPeriod (FloatValue("0"), FloatValue("100", 6), FloatValue("0.1"));
...
static ParameterManipulationDuration param_SineModulationB_ManipulationDuration (FloatValue("0"), FloatValue("10", 3), FloatValue("0.5"));
static ParameterManipulationPeriod   param_SineModulationB_ManipulationPeriod   (FloatValue("0"), FloatValue("10", 3), FloatValue("2.5", -3));
...
static ParameterPeriod    param_ImpulseB_Period   (FloatValue("33", -9), FloatValue("10", 6),  FloatValue("100", -3));
static ParameterDuration  param_ImpulseB_Duration (FloatValue("0"),      FloatValue("100", 6), FloatValue("100", -6));
