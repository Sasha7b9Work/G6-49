...
static ParameterManipulationDuration  param_SineModulationA_ManipulationDuration(FloatValue(0, 0, 0), FloatValue(10,    0, 0), FloatValue(5, 0, 0));
static ParameterManipulationPeriod    param_SineModulationA_ManipulationPeriod  (FloatValue(0, 0, 0), FloatValue(10000, 0, 0), FloatValue(0, 2, 500));
...
static ParameterPeriod    param_ImpulseA_Period   (FloatValue(0, 0, 0, 33), FloatValue(10 * 1000 * 1000,  0, 0), FloatValue(0, 1, 0));
static ParameterDuration  param_ImpulseA_Duration (FloatValue(0, 0, 0),     FloatValue(100 * 1000 * 1000, 0, 0), FloatValue(0, 0, 100));
...
static ParameterPeriod       param_PacketA_Period       (FloatValue(0, 0, 0), FloatValue(100 * 1000 * 1000, 0, 0), FloatValue(0, 0, 200));
static ParameterDuration     param_PacketA_Duration     (FloatValue(0, 0, 0), FloatValue(100 * 1000 * 1000, 0, 0), FloatValue(0, 0, 100));
static ParameterValue        param_PacketA_PacketNumber (ParameterValue::PacketNumber, "Кол-во имп", "Count imp", FloatValue(0, 0, 0), FloatValue(100 * 1000 * 1000, 0, 0), FloatValue(3, 0, 0));
static ParameterPacketPeriod param_PacketA_PacketPeriod (FloatValue(0, 0, 0), FloatValue(100 * 1000 * 1000, 0, 0), FloatValue(0, 1, 0));
...
static ParameterManipulationDuration param_SineModulationB_ManipulationDuration (FloatValue(0, 0, 0), FloatValue(10 * 1000, 0, 0), FloatValue(0, 5, 0));
static ParameterManipulationPeriod   param_SineModulationB_ManipulationPeriod   (FloatValue(0, 0, 0), FloatValue(10 * 1000, 0, 0), FloatValue(0, 0, 2500));
...
static ParameterPeriod    param_ImpulseB_Period   (FloatValue(0, 0, 0, 33), FloatValue(10 * 1000 * 1000, 0, 0),  FloatValue(0, 1, 0));
static ParameterDuration  param_ImpulseB_Duration (FloatValue(0, 0, 0),     FloatValue(100 * 1000 * 1000, 0, 0), FloatValue(0, 0, 100));
