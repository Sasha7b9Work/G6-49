...
#define __HAL_RCC_FMC_CLK_ENABLE() //-V2573
#define __HAL_RCC_GPIOF_CLK_ENABLE() //-V2573
#define __HAL_RCC_TIM2_CLK_ENABLE() //-V2573
#define __HAL_RCC_TIM3_CLK_ENABLE() //-V2573
#define __HAL_RCC_TIM2_CLK_DISABLE() //-V2573
#define __HAL_RCC_TIM3_CLK_DISABLE() //-V2573
#define __HAL_RCC_ADC3_CLK_ENABLE() //-V2573
#define __HAL_RCC_ADC3_CLK_DISABLE() //-V2573
#define __HAL_RCC_DAC_CLK_ENABLE() //-V2573
#define __HAL_RCC_DAC_CLK_DISABLE() //-V2573
#define __HAL_RCC_SPI4_CLK_ENABLE() //-V2573
#define __HAL_RCC_USB_OTG_FS_CLK_ENABLE() //-V2573
#define __HAL_RCC_USB_OTG_HS_CLK_ENABLE() //-V2573
#define __HAL_RCC_GPIOG_CLK_ENABLE() //-V2573
#define __HAL_RCC_GPIOH_CLK_ENABLE() //-V2573
#define __HAL_RCC_GPIOI_CLK_ENABLE() //-V2573
