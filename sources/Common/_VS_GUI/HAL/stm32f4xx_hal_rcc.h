...
#define __HAL_RCC_PWR_CLK_ENABLE() //-V2573
#define __HAL_RCC_GPIOB_CLK_ENABLE() //-V2573
#define __HAL_RCC_GPIOC_CLK_ENABLE() //-V2573
#define __HAL_RCC_GPIOA_CLK_ENABLE() //-V2573
#define __HAL_RCC_GPIOD_CLK_ENABLE() //-V2573
#define __HAL_RCC_GPIOE_CLK_ENABLE() //-V2573
#define __HAL_RCC_DMA2D_CLK_ENABLE() //-V2573
#define __HAL_RCC_LTDC_CLK_ENABLE() //-V2573
#define __HAL_RCC_TIM4_CLK_ENABLE() //-V2573
#define __HAL_RCC_SPI4_CLK_DISABLE() //-V2573
#define __HAL_RCC_USART3_CLK_ENABLE() //-V2573
#define __HAL_RCC_USART3_CLK_DISABLE() //-V2573
#define __HAL_RCC_SYSCFG_CLK_ENABLE() //-V2573
#define __HAL_RCC_GPIOA_CLK_ENABLE() //-V2573

#define __HAL_RCC_RTC_ENABLE() //-V2573
#define __HAL_RCC_RTC_DISABLE() //-V2573
