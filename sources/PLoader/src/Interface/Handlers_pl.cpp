...
bool PHandlers::Processing(SimpleMessage *msg)
{
    ...
    static const pFuncBpM funcs[Command::Count] =
    {
        ...
        /* RequestUpgrade             */ E,
        /* PortionUpgradeDevice       */ Updater::Handler,
        /* AnswerUpgradePanel         */ Updater::Handler,
        /* RequestPortionUpgradePanel */ Updater::Handler,
        /* AnswerPortionUpgradePanel  */ Updater::Handler
    };
