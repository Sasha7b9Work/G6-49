...
#define DMA2D_M2M_PFC               0                        /*!< DMA2D memory to memory with pixel format conversion transfer mode */
#define DMA2D_M2M_BLEND             0                        /*!< DMA2D memory to memory with blending transfer mode                */
#define DMA2D_R2M                   0                        /*!< DMA2D register to memory transfer mode                            */
