...
{ 
    ...
    CPU::PCD::handle.Init.dma_enable = DISABLE;
    CPU::PCD::handle.Init.ep0_mps = 0x40;
    CPU::PCD::handle.Init.phy_itface = PCD_PHY_EMBEDDED;
    CPU::PCD::handle.Init.Sof_enable = DISABLE;
    CPU::PCD::handle.Init.low_power_enable = DISABLE;
