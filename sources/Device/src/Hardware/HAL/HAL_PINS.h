...
#define WR_AD5697_OFFSET        HPort::_C, HPin::_2
#define WR_AD5697_FREQ          HPort::_C, HPin::_3
...
#define WR_FREQ_METER_CLK       HPort::_C, HPin::_1


// Пины чтения
#define RD_FREQ_METER_DRY       HPort::_C, HPin::_0
#define RD_FREQ_METER_DATA      HPort::_B, HPin::_12
