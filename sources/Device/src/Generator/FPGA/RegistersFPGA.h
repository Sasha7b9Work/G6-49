...
namespace FPGA
{
    namespace Register
    {
        ...
        enum E
        {
            ...
            _5_PerImp_PerPack_Freq_A,           // Период импульсов, период пакета импульсов, частота канала А
            _6_DurImp_NumbImp_A,                // Длительность импульсов, число ипульсов в пакете канала А
            _7_PerImp_Freq_B_DelayStartStop,    // Период импульсов канала В. В режиме СтартА-СтопВ - задержка между первым и вторым каналом
            _8_DurImp_B,                        // Длительность импульсов канала В
            _9_FreqMeter,
            _10_Offset,
            _11_Start,
            Count
