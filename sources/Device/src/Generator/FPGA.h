...
private:
    ...
    struct RG0
    {
        enum E
        {
            ...
            _3_ManipulationNoOSK1,  ///< Здесь 0, если манипуляция канала А выключена или не сигналом OSK1 (пилой)
            _4_ManipulationNoFPGA1, ///< Здесь 0, если манипуляция канала А выключена или не сигналом формирователя импульсов
            _5_ManipulationNoOSK2,  ///< Здесь 0, если манипуляция канала В выключена или не сигналом OSK2 (пилой)
            _6_ManipulationNoFPGA2, ///< Здесь 0, есил манипуляция канала В выключена или не сигналом формирователя импульсов
