...
static wxPanel *CreatePanelVertexes(wxDialog *dlg)
{
    ...
    dlg->Connect(ID_SPINCTRL_VERTEX_1, wxEVT_COMMAND_SPINCTRL_UPDATED, wxCommandEventHandler(ExponentDialog::OnControlEvent));
    ...
    dlg->Connect(ID_SPINCTRL_VERTEX_2, wxEVT_COMMAND_SPINCTRL_UPDATED, wxCommandEventHandler(ExponentDialog::OnControlEvent));
