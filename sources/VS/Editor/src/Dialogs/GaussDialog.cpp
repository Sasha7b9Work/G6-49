...
wxPanel *GaussDialog::CreatePanelWidth(wxDialog *dlg)
{
    ...
    scWidth = new SpinControl(panel, ID_SPINCTRL_NUMBER_PERIODS, wxPoint(x, y), wxSize(50, 20), 1, 1500, width, this, wxCommandEventHandler(Dialog::OnControlEvent), wxT("Шмирина"));
